...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
     ...
     * |---------------------------------------------------------------|
     * |Caps|LGui|LAlt|         Space         |RAlt| FN |  |Lef|Dow|Rig|
     * `---------------------------------------------------------------'
     */
    [L_BASE] = LAYOUT( \
        ...
        KC_CAPS, KC_LGUI,KC_LALT,                        KC_SPC,                 KC_RALT,MO(L_FN),KC_NO,       KC_LEFT,KC_DOWN,KC_RGHT \
    ),
    /* Function layer
     * ,---------------------------------------------------------------.
     * | ` | F1| F2| F3| F4| F5| F6| F7| F8| F9|F10|F11|F12|  Del  |PLY|
     * |---------------------------------------------------------------|
     * |     |   |   |   |   |   |   |   |INS|   |   |   |   |     |MUT|
     * |---------------------------------------------------------------|
     * |      |   |   |   |   |   |   |   |   |   |   |   |        |Vo+|
     ...
     * |       |   |   |   |   |   |   |   |   |   |   |       |   |Vo-|
     * |---------------------------------------------------------------|
     * |    |    |DskP|       DskRev          |DskR|    |  |Prv|   |Nxt|
     * `---------------------------------------------------------------'
     */
    [L_FN] = LAYOUT( \
        KC_GRV, KC_F1,  KC_F2,  KC_F3,  KC_F4,  KC_F5,  KC_F6,  KC_F7,  KC_F8,  KC_F9,  KC_F10, KC_F11, KC_F12, _______,KC_DEL,KC_MPLY,\
        _______,_______,_______,_______,_______,_______,_______,_______,KC_INS, _______,_______,_______,_______,_______,       KC_MUTE,\
        ...
        _______,_______,DK_PREV,                        DK_REVEAL,                DK_NEXT,_______,_______,        KC_MPRV,_______,KC_MNXT\
    ),
};
