 ...
 */
	...
	[_FN] = LAYOUT_true_hhkb(
		...
		KC_CAPS,          KC_MPRV,  KC_MNXT,  KC_MPLY,  ______,  ______,  ______,  ______,  ______,  KC_SLCK,  KC_PAUS,  KC_UP,   ______,  ______,
		KC_LCTL,             KC_VOLD,  KC_VOLU,  KC_MUTE,  ______,  ______,  ______,  ______,  KC_HOME, KC_PGUP,   KC_LEFT,   KC_RIGHT, ______,
		KC_LSFT,  ______,   RGB_MOD,  RGB_HUI,  RGB_HUD, RGB_SAI, RGB_SAD,   RGB_VAI,  RGB_VAD,  KC_END,  KC_PGDN, KC_DOWN,     ______,  ______,
		         ______,           ______,                    RGB_TOG,                              ______,            ______),
